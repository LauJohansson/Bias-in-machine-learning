...
df_local_all=pd.read_csv(PATH_orig+"/FFNN_metrics_crossvalidated_global_all.csv")
df_local_proc=pd.read_csv(PATH_orig+"FFNN_metrics_crossvalidated_local_"+procted_col_name+".csv")


# In[5]:


local_all_bar=sns.barplot(data=df_local_all[df_local_all["Measure"].isin(["FPR","FNR","TPR","TNR"])],x="Group", y="Value", ci=95,hue="Measure")
...
local_proc_bar=sns.barplot(data=df_local_proc[df_local_proc["Measure"].isin(["FPR","FNR","TPR","TNR"])],x="Group", y="Value", ci=95,hue="Measure")
...
###USE SMALL TEST
#titel_mitigation=titel_mitigation
#PATH_orig="/restricted/s164512/G2020-57-Aalborg-bias/lau/FFNN/models/"+titel_mitigation+"/"
...
get_df_w_metrics(df2_copy,"age_cat_custom",y_col_name,output_col_name)[["age_cat_custom","TPR","FPR","TNR","FNR","ACC"]]*100
