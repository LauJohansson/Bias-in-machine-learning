...
pathFall=pathRoot+"/Data/COMPAS_dataset.csv"
data=pd.read_csv(pathFall)


# In[63]:


cols=['is_recid','sex','age','race', 'juv_fel_count','juv_misd_count','juv_other_count','priors_count',"c_charge_desc","c_charge_degree"]
...
data.to_csv(pathRoot+"/Data/COMPAS_dataset_OHE.csv")
...
data[X_col_names] = pd.DataFrame(preprocessing.scale(data[X_col_names]),columns=X_col_names)


# In[71]:


data.to_csv(pathRoot+"/Data/COMPAS_dataset_OHE_std.csv")
