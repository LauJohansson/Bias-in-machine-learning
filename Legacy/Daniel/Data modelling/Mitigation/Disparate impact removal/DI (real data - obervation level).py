   ...
   # 
    ...
    # Plot non-normalized confusion matrix
     ...
     ############ FOR WOMEN ################   
        ...
        classified_df_W_local = X_test_rp[X_test_rp['Gender']==0].reset_index(drop=True)
    ...
    ############ FOR MEN ################    
        ...
        # getting data on observation level
        classified_df_M_local = X_test_rp[X_test_rp['Gender']==1].reset_index(drop=True)
...
classified_df
classified_df.to_csv('/restricted/s161749/G2020-57-Aalborg-bias/Plot_metrics/DI remove/RF_gender_obs.csv')
