   ...
   # 
    ...
    # Plot non-normalized confusion matrix
     ...
     ############ FOR WOMEN ################   
        ...
        classified_df_W_local['y_true'] = y_test[y_test['Gender']==0]['Fall'].drop(columns=['Gender']).reset_index(drop=True)
...
classified_df_W['Gender']=0
classified_df_M['Model']=model
classified_df_M['Gender']=1
classified_df = pd.concat([classified_df_W,classified_df_M])
classified_df
classified_df.to_csv('/restricted/s161749/G2020-57-Aalborg-bias/Plot_metrics/LFR/RF_gender_obs.csv')
