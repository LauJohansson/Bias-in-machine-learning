   ...
   # 
    ...
    # Plot non-normalized confusion matrix
     ...
     ############ FOR WOMEN ################   
        ...
        classified_df_W_local =  X_test[X_test['Gender']==0].copy()
    ...
    ############ FOR MEN ################    
        ...
        # getting data on observation level
        classified_df_M_local =  X_test[X_test['Gender']==1].copy()
...
classified_df
#classified_df.to_csv('/restricted/s161749/G2020-57-Aalborg-bias/Plot_metrics/Gender Swap/RF_gender_obs.csv')
